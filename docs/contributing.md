...
Contributions are welcome. `go-ruby-railties/railties` is built to a small set of
...
The library is in [`github.com/go-ruby-railties/railties`](https://github.com/go-ruby-railties/railties).
This documentation site is in [`github.com/go-ruby-railties/docs`](https://github.com/go-ruby-railties/docs).
