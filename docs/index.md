# go-ruby-railties documentation

**Pure-Go, MRI-4.0.5-faithful Ruby railties (no cgo)**

`go-ruby-railties/railties` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `railties`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-railties/railties`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `railties`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-railties/railties
```
...
| Repo | What it is |
| --- | --- |
| [`railties`](https://github.com/go-ruby-railties/railties) | the library — Ruby's `railties` in pure Go |
| [`docs`](https://github.com/go-ruby-railties/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-railties.github.io`](https://github.com/go-ruby-railties/go-ruby-railties.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-railties/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-railties/railties](https://github.com/go-ruby-railties/railties).
