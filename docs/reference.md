...
The public API lives at the module root (`github.com/go-ruby-railties/railties`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `railties`, while the surface follows
...
```go
import "github.com/go-ruby-railties/railties"
```
...
- **[pkg.go.dev/github.com/go-ruby-railties/railties](https://pkg.go.dev/github.com/go-ruby-railties/railties)**

The module's [README](https://github.com/go-ruby-railties/railties#readme) carries worked
